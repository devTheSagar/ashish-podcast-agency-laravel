        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.store-about-us') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-row">
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                    <label for="about-us-image" class="form-label">About us image</label>
                                    <input name="aboutUsImage" type="file" class="dropify @error('aboutUsImage') is-invalid @enderror" accept="image/*" value="{{ old('aboutUsImage') }}" id="about-us-image" data-height="200" />
                                    @error('aboutUsImage')
                            ...
                            <div class="form-row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
                                    ...
                                    <textarea name="aboutUsDetails" id="summernote" class="form-control @error('aboutUsDetails') is-invalid @enderror">{{ old('aboutUsDetails') }}</textarea>
