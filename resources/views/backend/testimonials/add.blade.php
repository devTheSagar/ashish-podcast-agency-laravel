        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.store-testimonial') }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                            <div class="form-row">
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name="date" class="form-control fc-datepicker @error('date') is-invalid @enderror" id="date" placeholder="DD/MM/YYYY" value="{{ old('date') }}" type="text">
                                        @error('date')
                            ...
                            <div class="form-row">
                                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 mb-3">
                                    ...
                                    <input name="designation" type="text" class="form-control @error('designation') is-invalid @enderror" id="designation" value="{{ old('designation') }}" required>
                                    {{-- <div class="valid-feedback">Looks good!</div> --}}
                                    @error('designation')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="form-row">
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 mb-3">
                                    ...
                                    <textarea name="testimonial" id="" rows="10" class="form-control @error('testimonial') is-invalid @enderror">{{ old('testimonial') }}</textarea>
                                    @error('testimonial')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
